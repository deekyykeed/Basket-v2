...
// UI SVG Icons
import NotificationSvgIcon from '../assets/icons/notifications/Bell-Notification--Streamline-Flex-Remix.svg';
import {
...
// ProfileIcon removed - using profile image in App.js instead
...
export const NotificationIcon = (props) => (
  <NotificationSvgIcon width={props.size || 24} height={props.size || 24} {...props} />
);
...
export const ClockIcon = (props) => (
  <SafeHugeiconsIcon icon={Clock01Icon} fallback="🕐" {...props} />
);

export const WalletIcon = (props) => (
  <SafeHugeiconsIcon icon={Wallet01Icon} fallback="💰" {...props} />
);

export const UserIcon = (props) => (
  <SafeHugeiconsIcon icon={UserCircleIcon} fallback="👤" {...props} />
);

export const ChevronDownIcon = (props) => (
  <SafeHugeiconsIcon icon={ArrowDown01Icon} fallback="▼" {...props} />
);
